...
public class AttendanceController {
  ...
  /**
   * Retrieves attendance records for a specific course group and date.
   */
  @GetMapping("/course/{courseGroupId}")
  public ResponseEntity<List<Attendance>> getAttendance(
      @PathVariable String courseGroupId, 
   ...
   */
  @PostMapping("/batch")
  public ResponseEntity<List<Attendance>> saveBatchAttendance(
